...
app = Flask(__name__)
banco.init_app(app)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://xsl40cyoa6lt6veb:ovg5zexqjxozoggq@yjo6uubt3u5c16az.cbetxkdyhwsb.us-east-1.rds.amazonaws.com:3306/f9p7m5j30z3y2jap'
